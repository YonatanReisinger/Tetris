...
public:
	...
	Computer(const Board& board, const Key keys[], const string name, Level level, int bestMoveScore = 0, int score = 0);
	...
	void findBestMove();
	int dropShapeAndEvaluatePlacement(Shape tmpShape);
